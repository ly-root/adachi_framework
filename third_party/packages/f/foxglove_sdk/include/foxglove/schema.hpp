...
struct Schema {
  ...
  std::string name;
  /// @brief The encoding of the schema data. For example "jsonschema" or
  /// "protobuf".
  ///
  /// The [well-known schema encodings] are preferred.
  ///
  /// [well-known schema encodings]:
  /// https://mcap.dev/spec/registry#well-known-schema-encodings
  std::string encoding;
  /// @brief Must conform to the schema encoding. If encoding is an empty
