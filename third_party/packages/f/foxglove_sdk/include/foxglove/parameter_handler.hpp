...
public:
  ...
  GetParametersResponder &
  operator=(GetParametersResponder &&) noexcept = default;
...
public:
  ...
  operator=(SetParametersResponder &&) noexcept = default;
...
struct ParameterHandler {
  ...
  std::function<void(uint32_t client_id,
                     std::optional<std::string_view> request_id,
                     const std::vector<std::string_view> &param_names,
                     GetParametersResponder &&responder)>
      onGet;
  ...
  std::function<void(uint32_t client_id,
                     ...
                     SetParametersResponder &&responder)>
      onSet;
};
