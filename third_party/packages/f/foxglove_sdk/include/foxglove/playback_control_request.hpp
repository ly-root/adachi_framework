...
public:
  ...
  /// @brief The requested seek time, in absolute nanoseconds. Will be
  /// std::nullopt if no seek requested.
  ...
  static PlaybackControlRequest
  from(const foxglove_playback_control_request &c_playback_control_request) {
    return {static_cast<PlaybackCommand>(
                c_playback_control_request.playback_command),
            ...
            c_playback_control_request.seek_time != nullptr
                ...
                : std::nullopt,
            std::string(c_playback_control_request.request_id.data,
                        c_playback_control_request.request_id.len)};
  }
};
